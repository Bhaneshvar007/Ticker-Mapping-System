app.controller("ConfirmationBroker", ["$scope", "clientuploadFactory", "$timeout", "$location", "Upload", "$window", function ($scope, clientuploadFactory, $timeout, $location, Upload, $window) {
